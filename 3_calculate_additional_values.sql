...
DELETE FROM bikesharing.vehicle_sightings_clean
...
UPDATE bikesharing.vehicle_sightings_clean
...
-- index: bike_sightings_clean_provider_idx

DROP INDEX IF EXISTS bike_sightings_clean_provider_idx;

CREATE INDEX bike_sightings_clean_provider_idx
  ON bikesharing.bike_sightings_clean
  USING btree
  (provider COLLATE pg_catalog."default");

-- index: bike_sightings_clean_stationary_idx

DROP INDEX IF EXISTS bike_sightings_clean_stationary_idx;

CREATE INDEX bike_sightings_clean_stationary_idx
  ON bikesharing.bike_sightings_clean
  USING btree
  (stationary);

-- index: bike_sightings_clean_bike_type_idx

DROP INDEX IF EXISTS bike_sightings_clean_bike_type_idx;

CREATE INDEX bike_sightings_clean_bike_type_idx
  ON bikesharing.bike_sightings_clean
  USING btree
  (bike_type COLLATE pg_catalog."default");

-- index: bike_sightings_clean_geom_gist

DROP INDEX IF EXISTS bike_sightings_clean_geom_gist;

CREATE INDEX bike_sightings_clean_geom_gist
  ON bikesharing.bike_sightings_clean
  USING gist
  (geom);

-- index: bike_sightings_clean_lead_geom_gist

DROP INDEX IF EXISTS bike_sightings_clean_lead_geom_gist;

CREATE INDEX bike_sightings_clean_lead_geom_gist
  ON bikesharing.bike_sightings_clean
  USING gist
  (lead_geom);

-- index: bike_sightings_clean_line_geom_gist

DROP INDEX IF EXISTS bike_sightings_clean_line_geom_gist;

CREATE INDEX bike_sightings_clean_line_geom_gist
  ON bikesharing.bike_sightings_clean
  USING gist
  (line_geom);
